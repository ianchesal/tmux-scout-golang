...
func printPreviewCapture(paneID string) {
	out, err := exec.Command("tmux", "capture-pane", "-pJ", "-t", paneID).Output() // #nosec G204 G702 -- paneID is a tmux pane identifier sourced from tmux's own session list, not user input
